...
//        case versions, animated
    ...
    init(frontDefault: String?, other: Other?/*, backDefault: String?, backFemale: JSONNull?, backShiny: String?, backShinyFemale: JSONNull?, frontFemale: JSONNull?, frontShiny: String?, frontShinyFemale: JSONNull?,  versions: Versions?, animated: Sprites?*/) {
